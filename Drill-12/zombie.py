...
class Zombie:
    ...
    def build_behavior_tree(self):
        ...
        away_chase_node = SelectorNode("Run of Move")
        away_chase_node.add_children(away_from_player_node, move_to_player_node)

        chase_node = SequenceNode("Chase")
        chase_node.add_children(find_player_node, away_chase_node)
        ...
        wander_eat_ball_chase_node.add_children(chase_node, eat_ball_node, wander_node)
    ...
    def draw(self):
        self.font.draw(self.x - 40, self.y + 45, 'HP : ' + str(self.hp), (255, 0, 0))
